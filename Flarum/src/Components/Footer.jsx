...
const Footer = () => {
  ...
  return (
    <div className="bg-white">
      <footer className="footer footer-center pt-10 text-base-content bg-textColor">
          ...
          <div className="grid grid-flow-col gap-4 text-white">
            <a>
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="fill-current cursor-pointer text-secondary-color hover:text-secondary duration-300"
              >
